...
const el = {
  ...
  providerSummaryType: document.getElementById('provider-summary-type'),
  providerSummaryExport: document.getElementById('provider-summary-export'),
  ganttYearFilter: document.getElementById('gantt-year-filter'),
  ganttProviderTypeFilter: document.getElementById('gantt-provider-type-filter'),
  pivotProviderTypeFilter: document.getElementById('pivot-provider-type-filter'),
